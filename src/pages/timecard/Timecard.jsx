...
const Timecard = () => {
  ...
  const { timePeriodTypes, userId } = useApplicationContext();
  ...
  useEffect(() => {
    ...
    updateTimeEntryContextData(date, setTimeEntries, userId);
...
const updateTimeEntryContextData = async (date, setTimeEntries, userId) => {
